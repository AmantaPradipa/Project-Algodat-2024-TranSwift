...
public class Main {
    public static void main(String[] args) {
        ...
        GraphBus.resetGraph();
        TiketBus.displayAllTicket();

        GraphTaksi.resetGraph();
        TiketTaksi.displayAllTicket();

        PenumpangBus.enqueue("Amanta", 200000, "Koper Pakaian", "Bus", "Bus");
            ...
            if (userType == 1) {
                ...
                while (true) {
                    ...
                    if (pelangganOption == 1) {
                        ...
                        if(label == "Bus"){
                            PenumpangBus.enqueue(namapenumpng, uang, namaBarang, label, label);
                        }
