...
public class Main {
    public static void main(String[] args) {
        ...
        PenumpangBus.enqueue("Amanta", 200000, "Koper Pakaian", 2, "Bus");
        PenumpangBus.pesanTiket("Amanta", "Bus", "Tokyo", "Nagoya");
        PenumpangBus.displayPenumpang();

        PenumpangTaksi.enqueue("Kevin", 200000, null, 0, "Taksi");
            ...
            if (userType == 1) {
                ...
                while (true) {
                    ...
                    if (pelangganOption == 1) {
                        ...
                        double beratBarang = scanner.nextInt();
                        scanner.nextLine();
                        ...
                        TiketBus.displayAllTicket("Bus");
                        TiketBus.displayAllTicket("Taksi");
